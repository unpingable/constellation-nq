...
-- The bounded recurring diagnostic office is an append-only trigger ledger.
-- Policies constrain what an enrollment may select; enrollments confer finite
-- slot authority; acquisitions and coordination events retain exact custody.
